"""Non-negative solution(for server)"""
...
def get_fitness(solution: np.array) -> np.float64:
    ...
    return - get_SigmaSQ(solution=solution)
...
num_parents_mating = int(sol_per_pop*3/4)

init_range_low = 0
init_range_high = 4

gene_space = [{'low': 0, 'high': 6000} for _ in range(N*N)]
...
# np.save('Solution.npy', ga_instance.solution)
